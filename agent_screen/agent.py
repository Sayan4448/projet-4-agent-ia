...
SYSTEM_PROMPT = (
    ...
    "- In messaging apps (Discord, Slack, WhatsApp), do NOT aim at sidebar rows to "
    "open a conversation: focus_window the app first, then use its quick switcher — "
    "hotkey ctrl+k on Discord — then type_text the exact channel/contact name and "
    "press_key enter. Deterministic and faster than pixel-aiming at a list row.\n"
